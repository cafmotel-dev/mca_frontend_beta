<?php $__env->startSection('title', 'Add Email Template Details'); ?>
                                    ...
                                    <div class="col-md-2">
                                        <label>Lead Status </label>
                                            <select id="lead_status" class="form-control" autocomplete="off" name="lead_status" >
                                                ...
                                                <option value="<?php echo e($list->lead_title_url); ?>"><?php echo e($list->title); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
                                            </select>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mca_crm\brightny-frontend\resources\views/email-templates/add.blade.php ENDPATH**/ ?>