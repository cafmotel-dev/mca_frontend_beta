                        ...
                        <td>
                            <ul class="list-inline m-0">
                               ...
                               <?php /* ?> <li class="list-inline-item">
                                    <a style="color:red;" type="submit" class="show_confirm" data-toggle="tooltip" data-id="{{$lead->id}}" title='Delete'><i class="fa fa-trash fa-lg"></i></a>
                                </li>
                                <?php */ ?>
...
</script><?php /**PATH C:\xampp\htdocs\mca_crm\mca-crm-frontend\resources\views/leads/leads_datatable.blade.php ENDPATH**/ ?>