<?php $__env->startSection('title', 'Add PDF Template Details'); ?>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <a style="float:right;text-decoration:none" href="<?php echo e(url('/email-templates')); ?>" class="btn-danger btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-eye"></i> Show PDF Templates</a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        ...
                        <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="template_name" value="<?php echo e(old('template_name')); ?>" class="form-control" id="template_name" required placeholder="Enter Template Name" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <label>Document Type </label>
                                            <select id="document_type" class="form-control" autocomplete="off" name="document_type" >
                                                ...
                                                <option value="<?php echo e($list->type_title_url); ?>"><?php echo e($list->title); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
                                                <?php endif; ?>
                                            </select>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <a href="/pdf_templates" type="button" class="btn btn btn-danger waves-effect waves-light" data-dismiss="modal"><i class="fa fa-reply"></i> Cancel</a>
                                ...
                                <button type="submit" name="submit" value="add" class="btn btn btn-primary waves-effect waves-light"><i class="fa fa-check-square-o"></i> Submit</button>
                            </div>
                        </div><!-- /.box-body -->
                    </form>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mca_crm\brightny-frontend\resources\views/pdf-templates/add.blade.php ENDPATH**/ ?>