<?php $__env->startSection('title', 'Edit Pdf Template Details'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Pdf Template</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-server" aria-hidden="true"></i> <b>Add Pdf Template Info</b></h3> 
                            <a style="float:right;text-decoration:none" href="<?php echo e(url('/pdf-templates')); ?>" class="btn-danger btn-sm" type="button" data-toggle="tooltip" data-placement="top" title="Add"><i class="fa fa-eye"></i> Show Pdf Templates</a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        ...
                        <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="template_name" value="<?php echo e(old('template_name', $pdf_template['template_name'])); ?>" class="form-control" id="template_name" required placeholder="Enter Template Name" />
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-md-2">
                                        <label>Sender Placeholders </label>
                                            <select id="multiple_names" class="form-control" autocomplete="off" >
                                                ...
                                                <option value="_<?php echo e($user_list); ?>_"><?php echo e($user_list); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <label>Document Type </label>
                                            <select id="document_type" class="form-control" autocomplete="off" name="document_type" >
                                                <option value="">Select to Insert</option>
                                                <?php $__currentLoopData = $document_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($pdf_template['document_type'] == $list->type_title_url ): ?> selected <?php endif; ?> value="<?php echo e($list->type_title_url); ?>"><?php echo e($list->title); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>;
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <label>Send Bcc </label>
                                            <select id="send_bcc" class="form-control" autocomplete="off" name="send_bcc" >
                                                <option <?php if($pdf_template['send_bcc'] == '1' ): ?> selected <?php endif; ?> value="1">Yes</option>
                                                <option <?php if($pdf_template['send_bcc'] == '0' ): ?> selected <?php endif; ?> value="0">No</option>
                                    ...
                                    <div class="col-md-12">
                                        <label style="line-height:100px;">Templete Preview </label>
                                            <textarea type="text" class="form-control" name="template_html" value="" id="editor1" ><?php echo e($pdf_template['template_html']); ?></textarea>
                                    </div>
                            ...
                            <div class="modal-footer">
                                 <a href="/pdf-templates" type="button" class="btn btn btn-danger waves-effect waves-light" data-dismiss="modal"><i class="fa fa-reply"></i> Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mca_crm\brightny-frontend\resources\views/pdf-templates/edit.blade.php ENDPATH**/ ?>