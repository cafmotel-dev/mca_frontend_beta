<?php $__env->startSection('title', 'Add Lead Info'); ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fa fa-tasks" aria-hidden="true"></i> <b>Add Lead
                                        Info</b></h3>
                            ...
                            <form method="post">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="assigned_to" id="assigned_to">
                                                    ...
                                                    <?php else: ?>
                                                    <option
                                                                value="<?php echo e(Session::get("userId")); ?>"><?php echo e(Session::get("first_name")); ?> <?php echo e(Session::get("last_name")); ?></option>
                                ...
                                <div class="modal-footer">
                                    <a href="/users" type="button" class="btn btn btn-danger waves-effect waves-light"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mca_crm\brightny-frontend\resources\views/leads/add.blade.php ENDPATH**/ ?>